...
public class GetUserDevicesResponse {
     ...
     */
    @JsonProperty("resultObj")
    public UserDevices getResultObj() {
        return resultObj;
    }
     ...
     */
    @JsonProperty("resultObj")
    public void setResultObj(UserDevices resultObj) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GetUserDevicesResponse) == false) {
            return false;
        }
        GetUserDevicesResponse rhs = ((GetUserDevicesResponse) other);
