...
public class DeviceList {
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(totalResults, rhs.totalResults).append(deviceList, rhs.deviceList).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
